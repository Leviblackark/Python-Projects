...
while coffee_machine:
    ...
    #  Access for entered order. “Sorry there is not enough water.” and for each one
        ...
        try:
            drink_choice = MENU[response]
            # Check if enough resources
            full_check = compare_resources(ingredients=drink_choice["ingredients"], machine_hold=resources)
            ...
            if full_check == 0:
                ...
                #  machine as the profit and this will be reflected the next time “report” is triggered
                    ...
                    resources = update_resources(machine_hold=resources, ingredients=drink_choice["ingredients"])
